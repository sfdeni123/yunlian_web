		...
		,get:function(url,data,callback,async){
			$.ajax({
				...
				,beforeSend: function(request) {
		            if(layui.data("yunlian_user").user != null){
						request.setRequestHeader("id",layui.data("yunlian_user").user.id);
		            	request.setRequestHeader("token",layui.data("yunlian_user").user.token);
					}
		        }
