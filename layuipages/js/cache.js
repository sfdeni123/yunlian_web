...
layui.use(['form', 'jquery', "layer"], function() {
	...
	function showNotice() {
		layer.open({
			...
			btn: ['火速围观'],
			moveType: 1,
			content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">本系统为开发测试版！</p></pclass></p><p>采用springboot、mybatis、log4j、layuicms2.4.5、mysql、redis开发，可在此基础上进行二次开发，后续更多功能将持续更新！温馨提示：<span class="layui-red">所有资源来源于互联网，如果对此有任何异议，请联系作者。</span></p></div>',
	...
	$("body").on("click", "#unlock", function() {
		if($(this).siblings(".admin-header-lock-input").val() == '') {
			...
			if("1234"===$(this).siblings(".admin-header-lock-input").val()){
